...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            FileTypeCheck fileTypeCheck = new FileTypeCheckImpl(new File("resources/test1.jpg"));
            System.out.println("Is Extension is correct for test1.jpg: " + fileTypeCheck.isExtensionCorrect());
            System.out.println("\n");


            FileTypeCheck fileTypeCheck2 = new FileTypeCheckImpl(new File("resources/test2.gif"));
            System.out.println("Is Extension is correct for test2.gif: " + fileTypeCheck2.isExtensionCorrect());
            System.out.println("\n");

            FileTypeCheck fileTypeCheck3 = new FileTypeCheckImpl(new File("resources/test3.png"));
            System.out.println("Is Extension is correct for test3.png: " + fileTypeCheck3.isExtensionCorrect());
            System.out.println("\n");

            FileTypeCheck fileTypeCheck4 = new FileTypeCheckImpl(new File("resources/test4.docx"));
            System.out.println("Is Extension is correct for test4.docx: " + fileTypeCheck4.isExtensionCorrect());
            System.out.println("\n");

            FileTypeCheck fileTypeCheck5 = new FileTypeCheckImpl(new File("resources/test5.rtf"));
